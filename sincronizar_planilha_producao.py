...
`_sincronizar_planilha_producao_25_08_2026` em app.py), não por uma checagem
de "tabela vazia". Em uso normal isso roda só UMA vez.

Regras combinadas com o Bruno (25/08/2026):
...
Campos deliberadamente NÃO importados desta planilha:
  ...
  - DESVIO / QTDE PEÇAS / DESCRIÇÃO / RNC: 100% vazios nesta planilha.
  - Liberação real: continua exclusivamente manual dentro do site (não
    existe coluna equivalente nesta planilha).
"""
...
from models import ESTACOES, FRETE_OPCOES, PRIORIDADE_OPCOES, STATUS_OPCOES, ItemPedido, Pedido
...
COL = {
    ...
    "vendedor": 11,
    "pedido_venda": 12,
    "descricao_produto": 13,
    "quantidade": 14,
    "rnc": 18,
    "inicio_producao": 19,
    "liberacao_faturamento": 22,
    "status_producao": 24,
    "estacao": 25,
    "venda_unidade": 26,
    "obs": 29,
    "liberacao_prevista": 30,
    "planejamento_semanal": 31,
}
        ...
        linhas.append(
            {
                ...
                "rnc": _parse_texto(_cell(ws, row, "rnc"), 120),
            }
        )
    return linhas
